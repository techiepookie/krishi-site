...
function ADHDTest() {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        const response = await api.get('/tests/adhd/questions');
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await api.post('/tests/adhd/submit', { answers });
      ...
      <div className="min-h-screen bg-gradient-to-b from-purple-900 via-indigo-900 to-blue-900 text-white p-4">
        <div className="container mx-auto max-w-2xl">
          <div className="flex items-center mb-8">
            ...
            <h1 className="text-2xl font-bold ml-4">ADHD Assessment</h1>
          </div>
      ...
      <div className="min-h-screen bg-gradient-to-b from-purple-900 via-indigo-900 to-blue-900 text-white p-4">
        <div className="container mx-auto max-w-2xl">
          <div className="flex items-center mb-8">
            ...
            <h1 className="text-2xl font-bold ml-4">ADHD Assessment Results</h1>
          </div>
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6">
            <div className="text-center mb-6">
              ...
              <p className="text-xl mb-2">Severity Level: {testResults.severity}</p>
            </div>
            <div className="mt-8">
